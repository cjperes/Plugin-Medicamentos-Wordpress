...
<!-- mensagem padrão dos medicamentos -->
<br clear="all" />		
<p style="background-color: #eeeeee!important; padding: 10px!important;"> Medicamento para o tratamento de  <?php print get_the_term_list(get_the_ID(), 'patologias', '<span>', ',', '</span>' ); ?>

              e na(s) especialidade(s) médica(s) <?php print get_the_term_list(get_the_ID(), 'especialidades', '<span>', ',', '</span>' ); ?>.

              Seu(s) princípio(s) ativo(s): <?php print get_the_term_list(get_the_ID(), 'principioativo', '<span>', ',', '</span>' ); ?>,
